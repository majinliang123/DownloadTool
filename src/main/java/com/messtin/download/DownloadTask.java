...
public class DownloadTask {
    ...
    public static void download(String urlStr, int threadNum) throws IOException {
        ...
        for(int i=0; i < threadNum; i++){
            ...
            workers.submit(new DownloadThread(urlConnection, startPos, endPos, fileName, i,latch));
        }
        workers.shutdown();
    }
